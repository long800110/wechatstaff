...
<div>
    <ul class="breadcrumb">
        ...
        <li>
            <a href="listQRCode">List QR Code</a>
        </li>
    </ul>
</div>
            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable ">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="center"><?php echo ($vo['scene_id']); ?></td>
                            <td class="center"><?php echo ($vo['action_name']); ?></td>
                            <td class="center"><?php echo ($vo['expire_seconds']); ?></td>
                            <td class="center"><?php echo ($vo['scan_result']); ?></td>
                            
                            <td class="center">
                            	<a class="btn btn-success" href="#" onClick="viewQRCode('<?php echo ($vo["id"]); ?>','<?php echo ($vo["ticket"]); ?>')">
